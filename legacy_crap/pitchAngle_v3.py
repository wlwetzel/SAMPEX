...
def findPitches(times,interpolate=True):
    ...
    pitchInfo = dataObj.read_time_range(real_Start,real_End,parameters=['A11',
     'A21', 'A31', 'A12', 'A22','A32', 'A13', 'A23', 'A33','B_X','B_Y','B_Z','B_Mag','Equator_B_Mag','Loss_Cone_1'])
...
if __name__ == '__main__':
    ...
    #%%
    i=1
    with open('/home/wyatt/Documents/SAMPEX/generated_Data/burst_Jan93.csv','a') as file:
